<?php /* Smarty version Smarty-3.1.12, created on 2015-08-24 07:57:11
         compiled from "E:\wamp\www\loov\ow_system_plugins\admin\views\controllers\users_roles.html" */ ?>
<?php /*%%SmartyHeaderCode:131755db0697519ec4-81881392%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '06519226009c5c64dd1d98930776962c251e869f' => 
    array (
      0 => 'E:\\wamp\\www\\loov\\ow_system_plugins\\admin\\views\\controllers\\users_roles.html',
      1 => 1437323474,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '131755db0697519ec4-81881392',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55db0697915836_95122616',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55db0697915836_95122616')) {function content_55db0697915836_95122616($_smarty_tpl) {?><?php if (!is_callable('smarty_block_script')) include 'E:\\wamp\\www\\loov\\ow_smarty\\plugin\\block.script.php';
if (!is_callable('smarty_function_url_for')) include 'E:\\wamp\\www\\loov\\ow_smarty\\plugin\\function.url_for.php';
...
if (!is_callable('smarty_function_text_edit')) include 'E:\\wamp\\www\\loov\\ow_smarty\\plugin\\function.text_edit.php';
...
" class="edit_role"><?php echo smarty_function_text(array('key'=>'base+no'),$_smarty_tpl);?>
			...
			<tr class="ow_tr_last">
				...
				<td colspan="3" style="text-align: left;">
					...
					<form>
                                                <?php $_smarty_tpl->_capture_stack[0][] = array("selectRoleAlert", null, null); ob_start(); ?><?php echo smarty_function_text(array('key'=>'admin+permissions_please_select_role'),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                                                ...
                                                <?php $_smarty_tpl->_capture_stack[0][] = array("areYouSure", null, null); ob_start(); ?><?php echo smarty_function_text(array('key'=>'admin+permissions_please_select_role'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
						...
						<script type="text/javascript">
							window.delRoles = function(){
								if( $('#roles tr.role td input:checkbox:checked').size() == 0 ){ 
									alert('<?php echo preg_replace("%(?<!\\\\)'%", "\'",Smarty::$_smarty_vars['capture']['selectRoleAlert']);?>
');
									return false;
								}

								return confirm('<?php echo preg_replace("%(?<!\\\\)'%", "\'",Smarty::$_smarty_vars['capture']['areYouSure']);?>
');
							};
						</script>
